...
Decida se a mensagem é uma promoção de um produto do Mercado Livre (mercadolivre.com.br ou mercadolibre.com) ou da Shopee (shopee.com.br), incluindo links de encurtador/rastreador que podem levar pra lá — nesse caso ainda assim considere como possível promo válida e devolva o link como veio na mensagem.

Se for uma promoção do Mercado Livre ou da Shopee, extraia:
...
Se a mensagem não for sobre uma promoção do Mercado Livre nem da Shopee (ex: é conversa comum, ou é promoção de outro site/marketplace), retorne isPromo: false e os demais campos null.`;
